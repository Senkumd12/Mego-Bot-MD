  ...
  m.react('💔')
   ...
   let str = `
      ┓━ ╼━━━╃⌬〔 SENKU_𝒃𝒐𝒕 〕⌬╄━━━╾ ━┏
 مـرحــبـا ${taguser} 👋🏻
*كم من شخص ارد...ارااااد لاتخف لم يحصل💫💔*
≼👤≽ مـعـلــومـات الـبــوت╿↶
━ ── • ꕤ • ── ━
 اســم الـبــوت  :سينكو بوت お ‘ 
منـصـه التـشغيــل 【.هيروكو.】
وقت التشغيل : ${uptime}
اليوم : ${week}
التاريخ : ${date}
مطوري : wa.me/+212658594530
⋄━───═◞⬪⇊⬪◟═───━⋄
اذا لم يرد عليك البوت عليك ارسال 
⚡⇇.صلح 
⚡⇇.تصليح
━ ── • ꕤ • ── ━
⇊ قوائم بوت سينكوو المطلوبه ⇊
.....................
🤖⇇.ذكاءاصطناعي
⛩️⇇ .الجروب
🔮⇇.الانمي
...
📮⇇.قوانين
━ ── • ꕤ • ── ━
👋🏻 هلا اذا اردت الوصول ٨
٩٧اللي الاوامر مره واحده كامله ارسل
